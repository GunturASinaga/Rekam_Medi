...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center my-3">
            <h1>Alergi</h1>
            <a href="/tambahAlergi" class="btn btn-success btn-sm">Tambah Alergi</a>
        </div>
        ...
        <ul>
            ...
            <li class="mb-3">
                ...
                <div class="btn-group card-body">
                    <a href="/alergiEdit/{{ $aler['id'] }}" class="btn btn-success btn-sm">Edit</a>
                    <a href="/alergiHapus/{{ $aler['id'] }}" class="btn btn-danger btn-sm">Hapus</a>
                </div>
            </li>
            @endforeach
        </ul>
